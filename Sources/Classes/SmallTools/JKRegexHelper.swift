...
public enum JKRegexCharacterType: String {
    ...
    /*
     ...
     "\\u4e00-\\u9fa5"
     */
    // case type13 = "^[a-zA-Z0-9\\u4e00-\\u9FA5A.,!?;:()\\[\\]\\{\\}\\\"'\\-_@#$%^&*+=<>/\\\\|`~]+$"
    case type14 = "^[a-zA-Z0-9\\u4e00-\\u9FA5A!@#$%^&*()_+-=\\[\\]{};':\"\\\\|,.<>/?！@#￥%……&*（）——+=-【】{}；：“”‘’|、，。《》？]+$"
    /// 标准英文、数字及常见符号(不包含 空格和emjo表情)
    // case type14 = "^[a-zA-Z0-9.,!?;:()\\[\\]\\{\\}\\\"'\\-_@#$%^&*+=<>/\\\\|`~]+$"
    case type15 = "^[a-zA-Z0-9!@#$%^&*()_+-=\\[\\]{};':\"\\\\|,.<>/?！@#￥%……&*（）——+=-【】{}；：“”‘’|、，。《》？]+$"
}
