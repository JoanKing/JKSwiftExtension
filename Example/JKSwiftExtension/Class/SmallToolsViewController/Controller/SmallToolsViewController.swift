...
class SmallToolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataArray = ["JKAsyncs", "JKTextFieldAutoLimiter", "JKTextViewAutoLimiter", "JKDiamondView", "JKTransparentHitTestImageView", "JKImageButton", "JKTaskManager", "JKScrollviewCardLayout", "JKScreenShieldView", "JKOperator", "JKFileLog", "JKAlertViewController", "JKUnitConverter", "JKCustomPickView", "JKCircleProgressView", "JKRollingNoticeView", "JKPaddingLabel", "JKPhotoAlbumUtil", "JKTapActionLabel", "JKDrawSignatureView", "JKGlobalTools", "JKRegexHelper", "JKCommonTool", "JKContentSize", "JKPanView", "JKPrint", "JKWeakTimer", "JKRuntime", "JKPlaceHolderTextView", "JKWaterFallLayout", "KeyboardAccessory", "QRCodeImageFactory", "JKDarkModeUtil"]
        finishedDataArray = ["JKAsyncs", "JKTextFieldAutoLimiter", "JKTextViewAutoLimiter", "JKDiamondView", "JKTransparentHitTestImageView", "JKImageButton", "JKTaskManager", "JKScrollviewCardLayout", "JKScreenShieldView", "JKOperator", "JKFileLog", "JKAlertViewController", "JKCustomPickView", "JKCircleProgressView", "JKRollingNoticeView", "JKPhotoAlbumUtil", "JKPaddingLabel", "JKPanView", "JKDrawSignatureView", "JKGlobalTools", "JKWeakTimer", "JKPrint", "JKRuntime", "QRCodeImageFactory", "JKCommonTool", "JKContentSize", "JKWaterFallLayout", "JKPlaceHolderTextView", "KeyboardAccessory", "JKRegexHelper", "JKTapActionLabel", "JKDarkModeUtil"]
        initUI()
    }
