...
class SmallToolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataArray = ["JKAsyncs", "JKEKEvent", "JKPaddingLabel", "JKContactsKit", "JKPhotoAlbumUtil", "JKTapActionLabel", "JKDrawSignatureView", "JKGlobalTools", "JKRegexHelper", "JKCommonTool", "JKContentSize", "JKPrint", "WeakTimer", "JKRuntime", "JKWaterFallLayout", "KeyboardAccessory", "QRCodeImageFactory", "JKDarkModeUtil"]
        finishedDataArray = ["JKAsyncs", "JKEKEvent", "JKContactsKit", "JKPhotoAlbumUtil", "JKPaddingLabel", "JKDrawSignatureView", "JKGlobalTools", "WeakTimer", "JKPrint", "JKRuntime", "QRCodeImageFactory", "JKCommonTool", "JKContentSize", "JKWaterFallLayout", "KeyboardAccessory", "JKRegexHelper", "JKTapActionLabel", "JKDarkModeUtil"]
        initUI()
    }
