...
class SmallToolsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataArray = ["JKAsyncs", "JKGlobalTools", "JKRegexHelper", "JKCommonTool", "JKContentSize", "JKValidateHelper", "JKVerticalCarousel", "JKPrint", "WeakTimer", "JKRuntime", "JKWaterFallLayout", "KeyboardAccessory", "MaskingManager+Extension", "QRCodeImageFactory"]
        finishedDataArray = ["JKAsyncs", "JKGlobalTools", "WeakTimer", "JKPrint", "JKRuntime", "QRCodeImageFactory", "JKCommonTool", "JKContentSize", "JKValidateHelper", "JKVerticalCarousel", "JKWaterFallLayout", "MaskingManager+Extension", "KeyboardAccessory", "JKRegexHelper"]
        initUI()
    }
