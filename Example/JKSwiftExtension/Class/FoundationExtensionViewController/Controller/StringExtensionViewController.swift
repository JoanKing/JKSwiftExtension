...
extension StringExtensionViewController {
    ...
    @objc func test38() {
        ...
        JKPrint("url进行编码", "\(testString1) 编码后为：\(testString1.jk.urlValidate())")
    }
