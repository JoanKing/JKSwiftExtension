...
class FoundationExtensionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        finishedDataArray = ["String+Extension", "Date+Extension", "Array+Extension", "Bundle+Extension", "NSObject+Extension", "UserDefaults+Extension", "UIFont+Extension", "Float+Extension", "Double+Extension", "CGFloat+Extension", "Int+Extension", "Int64+Extension", "UInt+Extension", "Character+Extension", "Bool+Extension", "UIColor+Extension", "DateFormatter+Extension", "Dictionary+Extension", "URL+Extension", "NSDecimalNumberHandler+Extension", "FileManager+Extension", "Timer+Extension", "UIDevice+Extension"]
        initUI()
    }
