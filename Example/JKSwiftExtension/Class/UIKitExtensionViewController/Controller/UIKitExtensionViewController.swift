...
class UIKitExtensionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dataArray = ["UIView+Extension", "CALayer+Extension", "CATextLayer+Extension", "NSMutableAttributedString+Extension", "UIAlertController+Extension", "UIApplication+Extension", "UIBarButtonItem+Extension", "UIBezierPath+Extension", "UIButton+Extension", "UIControl+Extension", "UIImage+Extension", "UIImageView+Extension", "UILabel+Extension", "UINavigationController+Extension", "UIScreen+Extension", "UIScrollView+Extension", "UIStackView+Extension", "UISwitch+Extension", "UITableView+Extension", "UITextField+Extension", "UITextView+Extension", "UIViewController+Extension"]
        finishedDataArray = ["UIView+Extension", "CALayer+Extension", "UIScreen+Extension", "CATextLayer+Extension", "UIControl+Extension", "NSMutableAttributedString+Extension", "UIAlertController+Extension", "UIApplication+Extension", "UISwitch+Extension", "UIBarButtonItem+Extension", "UIButton+Extension", "UILabel+Extension", "UITableView+Extension", "UINavigationController+Extension", "UIViewController+Extension", "UIScrollView+Extension", "UITextView+Extension", "UIStackView+Extension", "UITextField+Extension", "UIBezierPath+Extension", "UIImage+Extension", "UIImageView+Extension"]
        initUI()
    }
