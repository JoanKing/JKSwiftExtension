...
class UIKitExtensionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        finishedDataArray = ["UITableView+Extension", "UIImage+Extension", "CALayer+Extension", "UIImageView+Extension", "UIButton+Extension", "UILabel+Extension", "UIScreen+Extension", "UISwitch+Extension", "UINavigationController+Extension", "UIScrollView+Extension", "UITextField+Extension", "UIViewController+Extension", "UIView+Extension", "UITableViewCell+Extension", "UIApplication+Extension", "UIBarButtonItem+Extension", "UIBezierPath+Extension"]
        initUI()
    }
