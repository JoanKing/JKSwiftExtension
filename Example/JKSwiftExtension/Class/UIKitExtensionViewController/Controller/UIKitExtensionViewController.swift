...
class UIKitExtensionViewController: UIViewController {
    ...
    lazy var tableView : UITableView = {
        ...
        tableView.register(HomeViewCell.self, forCellReuseIdentifier: UIKitExtensionViewController.UIKitExtensionViewControllerCellIdentifier)
    ...
    override func viewDidLoad() {
        ...
        dataArray = ["UITabBarController+Extension", "CAGradientLayer+Extension", "UIView+Extension", "UITableViewCell+Extension", "UISlider+Extension", "UICollectionView+Extension", "UINavigationBar+Extension", "CALayer+Extension", "CATextLayer+Extension", "UIAlertController+Extension", "UIApplication+Extension", "UIBarButtonItem+Extension", "UIBezierPath+Extension", "UIButton+Extension", "UIControl+Extension", "UIImage+Extension", "UIImageView+Extension", "UILabel+Extension", "UINavigationController+Extension", "UIColor+Extension", "UIScreen+Extension", "UIScrollView+Extension", "UIStackView+Extension", "UISwitch+Extension", "UITableView+Extension", "UITextField+Extension", "UITextView+Extension", "UIViewController+Extension"]
        finishedDataArray = ["CAGradientLayer+Extension", "UITableView+Extension", "UIImage+Extension", "CALayer+Extension", "UIImageView+Extension", "UIButton+Extension", "UILabel+Extension", "UIScreen+Extension", "UISwitch+Extension", "UINavigationController+Extension", "UIScrollView+Extension", "UITextField+Extension", "UIViewController+Extension", "UIView+Extension", "UITableViewCell+Extension", "UIApplication+Extension", "UIBarButtonItem+Extension", "UIBezierPath+Extension", "UITabBarController+Extension", "UISlider+Extension"]
        initUI()
    }
