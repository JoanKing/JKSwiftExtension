...
class UIKitExtensionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        finishedDataArray = ["UIView+Extension", "CALayer+Extension", "UIScreen+Extension", "CATextLayer+Extension", "UIControl+Extension", "NSMutableAttributedString+Extension", "UIAlertController+Extension", "UIApplication+Extension", "UISwitch+Extension", "UIBarButtonItem+Extension", "UIButton+Extension", "UILabel+Extension"]
        initUI()
    }
