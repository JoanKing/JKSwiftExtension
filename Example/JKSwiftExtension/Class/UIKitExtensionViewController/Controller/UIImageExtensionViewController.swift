...
extension UIImageExtensionViewController {
    ...
    // MARK:
    @objc func test89(eventsClosure: @escaping ((String, String) -> Void)) {
        test1234(age1: ("哈哈", "呵呵"), eventsClosure: eventsClosure)
    }
    
    func test1234<T>(age1: T, eventsClosure: @escaping ((T) -> Void)) {
        // 重新刷新表格数据
